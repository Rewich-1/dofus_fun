...
def find_line(name_ressource):
    ...
    while True:
        try:
            ...
            y = y + 46
            nb_ligne = nb_ligne + 1
            if (math.sqrt((color_list[0] - 36) ** 2) > 10 or math.sqrt((color_list[1] - 216) ** 2) > 10 or math.sqrt((color_list[2] - 246) ** 2) > 10):
                break
        except:
            print("mort")
    ...
    for i in range(nb_ligne):
        ...
        if name_test == name_ressource.replace("é", "e").replace("ê", "e"):
            #print('trouve!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
