...
def gestion_prix(resource):
    ...
    while True:
        ...
        if (math.sqrt((color_list[0] - 78) ** 2) < 35and math.sqrt((color_list[1] - 85) ** 2) < 35 and math.sqrt((color_list[2] - 83) ** 2) <35):
            break
    # ==============================================
    ...
    while True and good_line :
        ...
        color_list = couleur.RGB(color)
        time.sleep(0.5)
        if (math.sqrt((color_list[0]-35))**2<10 and math.sqrt((color_list[1]-39)**2)<10 and math.sqrt((color_list[2]-39)**2) <10 ):



            # prendre screen du prix
            take_screen.take_screen('prix100', good_line['x']+279, good_line['y']+154, good_line['x']+400, good_line['y']+167)
